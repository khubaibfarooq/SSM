                            ...
                            <Card.Body>
                                ...
                                <div className="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        ...
                                        <Link href="#" className={"text-decoration-underline " + item.captionClass}>{item.caption}</Link>
                                    </div>
