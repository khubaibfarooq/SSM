...
const RightSidebar = (props: any) => {
    ...
    useEffect(() => {
        ...
        // Open customizer only on first dashboard visit per session
        const hasOpened = sessionStorage.getItem('customizerOpened');
        if (window.location.pathname === "/" && !hasOpened) {
            setOpen(true);
            sessionStorage.setItem('customizerOpened', 'true');
        }
    }, [pathName]);
                                    ...
                                    <React.Fragment>
                                        ...
                                        <div id="layout-position">
                                            ...
                                            <div className="btn-group radio" role="group">
                                                ...
                                                />
                                                <Form.Check.Label className="btn btn-light w-sm" htmlFor="layout-position-fixed">Fixed</Form.Check.Label>
                                                ...
                                                />
                                                <Form.Check.Label className="btn btn-light w-sm ms-0" htmlFor="layout-position-scrollable">Scrollable</Form.Check.Label>
                                            </div>
                                        </div>
                                    </React.Fragment>
                                )}
