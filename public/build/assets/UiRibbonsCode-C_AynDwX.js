import{j as s}from"./app-BxV1Qh5z.js";import{P as a}from"./Prism-CITxvmdT.js";const i=`
<!-- Rounded Ribbon -->
...
`,r=()=>s.jsx(a,{code:i,language:"html",plugins:["line-numbers"]}),e=`
<!-- Ribbon Shape -->
<Card className="ribbon-box border shadow-none mb-lg-0">
    <Card.Body>
...
`,l=()=>s.jsx(a,{code:e,language:"html",plugins:["line-numbers"]}),t=`
<!-- Filled Ribbons -->
...
`,b=()=>s.jsx(a,{code:t,language:"html",plugins:["line-numbers"]}),o=`
<!-- Boxed Ribbons -->
<Card className="ribbon-box border shadow-none mb-lg-0">
...
`,c=()=>s.jsx(a,{code:o,language:"html",plugins:["line-numbers"]}),d=`
<!-- Ribbons -->
<Card className="ribbon-box border shadow-none mb-lg-0">
    <Card.Body className="text-muted">
...
`,p=()=>s.jsx(a,{code:d,language:"html",plugins:["line-numbers"]}),n=`
<!-- Ribbons Hover -->
...
`,N=()=>s.jsx(a,{code:n,language:"html",plugins:["line-numbers"]});export{c as BoxedRibbonsExample,b as FilledRibbonsExample,l as RibbonShapeExample,p as RibbonsExample,N as RibbonsHoverExample,r as RoundedRibbonExample};
