import{j as e,R as o}from"./app-BV4iq9AN.js";import{P as l}from"./Prism-C30nvFYC.js";const i=()=>e.jsx(o.Fragment,{children:e.jsx(l,{code:`<Row>
<Col lg={6}>
...
`,language:"react"})}),s=()=>e.jsx(o.Fragment,{children:e.jsx(l,{code:`<Row>
    <Col lg={6}>
        <select className="form-select mb-3" aria-label="Default select example">
            <option >Select your Status </option>
            <option defaultValue="1">Declined Payment</option>
    ...
    `,language:"react"})}),p=()=>e.jsx(o.Fragment,{children:e.jsx(l,{code:`<Row className="align-items-center g-3">
<Col lg={4}>
...
`,language:"react"})});export{i as DefaultSelect,s as MenuSize,p as SelectSize};
