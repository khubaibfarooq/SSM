import{j as t}from"./app-CyIHl2iJ.js";import{P as o}from"./Prism-B5ivrfkD.js";const s=`<!-- Default Toast --> 
...
<div className="bg-light" style={{ position: "relative", minHeight: "200px" }}>
    <Toast show={toast5} style={{ position: "absolute", top: "16px", right: "16px" }}>
...
`,r=()=>t.jsx(o,{code:s,language:"html",plugins:["line-numbers"]}),e=`
<!-- Toast Placement -->
...
`,c=()=>t.jsx(o,{code:e,language:"html",plugins:["line-numbers"]}),a=`
...
`,m=()=>t.jsx(o,{code:a,language:"html",plugins:["line-numbers"]}),i=`<!-- Toast -->
...
`,d=()=>t.jsx(o,{code:i,language:"html",plugins:["line-numbers"]});export{r as BootstrapToastsExample,m as BorderIconExample,c as ToastPlacementExample,d as ToastifyExample};
