import{j as e,R as c}from"./app-BxV1Qh5z.js";import{P as o}from"./Prism-CITxvmdT.js";const i=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col lg={4} md={6}>                                                    
<div>   
...
`,language:"html"})}),l=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col md={6}>
    <div>                                               
...
`,language:"html"})}),r=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col lg={4} md={6}>
<div>
...
`,language:"html"})}),t=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col md={6}>
<div>
...
`,language:"html"})}),s=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col lg={4} md={6}>
<div>
...
`,language:"html"})}),d=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col md={6}>
<div>
...
<Col md={6}>
    ...
    `,language:"html"})}),k=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col md={6}>
<div>
...
<Col md={6}>
    <div className="mt-4 mt-md-0">
        ...
        `,language:"html"})}),f=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col lg={4}>
...
`,language:"html"})}),n=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<Col lg={4}>
    <div className="mt-4 mt-lg-0">
        <div className="form-check form-check-inline">
...
`,language:"html"})}),b=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<div className="hstack gap-2 flex-wrap">
...
`,language:"html"})}),C=()=>e.jsx(c.Fragment,{children:e.jsx(o,{code:`<div className="hstack gap-2 flex-wrap">
<Form.Check.Input type="radio" className="btn-check" name="options" id="option1" defaultChecked/>
<Form.Check.Label className="btn btn-secondary" htmlFor="option1">Checked</Form.Check.Label>
...
`,language:"html"})});export{i as Checkbox,l as CustomCheckbox,t as CustomRadio,k as CustomSwitches,f as InlineCheckboxRadio,C as OutlinedStyles,r as Radio,b as RadioToggleButtons,d as SwitchColor,s as Switches,n as WithoutLabels};
