import{j as e}from"./app-BxV1Qh5z.js";import{P as s}from"./Prism-CITxvmdT.js";const t=`
<!-- Default List -->
<ListGroup>
...
`,N=()=>e.jsx(s,{code:t,language:"html",plugins:["line-numbers"]}),i=`
<!-- Active Item -->
<ListGroup>
...
`,x=()=>e.jsx(s,{code:i,language:"html",plugins:["line-numbers"]}),a=`
<!-- Disabled Items -->
<ListGroup>
...
`,b=()=>e.jsx(s,{code:a,language:"html",plugins:["line-numbers"]}),m=`
<!-- List with Link -->
...
`,k=()=>e.jsx(s,{code:m,language:"html",plugins:["line-numbers"]}),l=`
<!-- List with Button -->
<ListGroup>
...
`,y=()=>e.jsx(s,{code:l,language:"html",plugins:["line-numbers"]}),r=`
<!-- Flush List -->
<ListGroup flush>
...
`,w=()=>e.jsx(s,{code:r,language:"html",plugins:["line-numbers"]}),o=`
<!-- Start Alignment -->
...
`,C=()=>e.jsx(s,{code:o,language:"html",plugins:["line-numbers"]}),n=`
<!-- Contextual Classes -->
<ListGroup>
...
`,A=()=>e.jsx(s,{code:n,language:"html",plugins:["line-numbers"]}),u=`
<!-- Contextual Classes with Link -->
<ListGroup>
    <ListGroupItem variant="" as="a" href="#" className="list-group-item-action">A simple default list group item</ListGroupItem>
...
`,S=()=>e.jsx(s,{code:u,language:"html",plugins:["line-numbers"]}),p=`
<!-- Colored Lists -->
<ListGroup>
    <ListGroupItem >Dapibus ac facilisis in</ListGroupItem>
...
`,j=()=>e.jsx(s,{code:p,language:"html",plugins:["line-numbers"]}),c=`
<!-- Custom Content -->
<ListGroup>
...
`,E=()=>e.jsx(s,{code:c,language:"html",plugins:["line-numbers"]}),d=`
<!-- List with Badges -->
<ListGroup>
...
`,D=()=>e.jsx(s,{code:d,language:"html",plugins:["line-numbers"]}),g=`
<!-- List with Checkboxs -->
<ListGroup>
...
`,M=()=>e.jsx(s,{code:g,language:"html",plugins:["line-numbers"]}),L=`
<!-- List with Radios -->
<ListGroup>
    <ListGroupItem as="label">
...
`,B=()=>e.jsx(s,{code:L,language:"html",plugins:["line-numbers"]}),G=`
<!-- List with Icon -->
<ListGroup>
...
`,R=()=>e.jsx(s,{code:G,language:"html",plugins:["line-numbers"]}),I=`
<!-- List with Numbered -->
...
`,W=()=>e.jsx(s,{code:I,language:"html",plugins:["line-numbers"]}),h=`
...
`,z=()=>e.jsx(s,{code:h,language:"html",plugins:["line-numbers"]});export{x as ActiveItemExample,j as ColoredListExample,A as ContextualClassExample,S as ContextualLinkExample,E as CustomContentExample,z as CustomListExample,N as DefaultListExample,b as DisabledItemExample,w as FlushListExample,C as HorizontalListExample,D as ListBadgeExample,y as ListButtonExample,M as ListCheckboxExample,R as ListIconExample,W as ListNumberedExample,B as ListRadioExample,k as ListlinkExample};
