import{j as e}from"./app-BxV1Qh5z.js";import{P as r}from"./Prism-CITxvmdT.js";const l=`
<!-- Primary Alert -->
...
`,y=()=>e.jsx(r,{code:l,language:"html",plugins:["line-numbers"]}),t=`
<!-- Primary Alert -->
...
<Alert varient="dark" className="border-0 border-0 mb-0">
    <strong>Did you know?</strong> A simple <b>dark alert</b> —check it out!
</Alert>`,v=()=>e.jsx(r,{code:t,language:"html",plugins:["line-numbers"]}),a=`
<!-- Primary Alert -->
<Alert varient="primary">
...
</Alert>`,p=()=>e.jsx(r,{code:a,language:"html",plugins:["line-numbers"]}),i=`
<!-- Primary Alert -->
<Alert varient="primary">
...
</Alert>`,N=()=>e.jsx(r,{code:i,language:"html",plugins:["line-numbers"]}),s=`
const [show, setShow] = useState<boolean>(false);
<Alert varient="success" isOpen={show} toggle={() => setShow(false)}>
    Nice, you triggered this alert message!
</Alert>
<button type="button" className="btn btn-primary" id="liveAlertBtn" onClick={() => setShow(true)}>Show live alert</button>`,f=()=>e.jsx(r,{code:s,language:"jsx",plugins:["line-numbers"]}),n=`
<!-- Primary Alert -->
...
</Alert>`,k=()=>e.jsx(r,{code:n,language:"html",plugins:["line-numbers"]}),o=`
<!-- Primary Alert -->
...
</Alert>`,w=()=>e.jsx(r,{code:o,language:"html",plugins:["line-numbers"]}),c=`
<!-- Primary Alert -->
...
</Alert>`,x=()=>e.jsx(r,{code:c,language:"html",plugins:["line-numbers"]}),d=`
<!-- Primary Alert -->
...
</Alert>`,L=()=>e.jsx(r,{code:d,language:"html",plugins:["line-numbers"]}),g=`
<!-- Primary Alert -->
...
</Alert>`,S=()=>e.jsx(r,{code:g,language:"html",plugins:["line-numbers"]}),m=`
<!-- Primary Alert -->
...
</Alert>`,D=()=>e.jsx(r,{code:m,language:"html",plugins:["line-numbers"]}),b=`
<!-- Primary Alert -->
...
`,W=()=>e.jsx(r,{code:b,language:"html",plugins:["line-numbers"]}),A=`
<!-- Primary Alert -->
...
</Alert>`,I=()=>e.jsx(r,{code:A,language:"html",plugins:["line-numbers"]});export{W as AdditionalContentAlertsExample,v as BorderlessExample,y as DefaultAlertsExample,p as DismissingExample,x as LabelIconAlertsExample,S as LabelIconArrowAlertsExample,w as LeftBorderAlertsExample,N as LinkColorExample,f as LiveExample,k as OutlineAlertsExample,D as RoundedLabelIconAlertsExample,I as SolidAlertsExample,L as TopBarAlertsExample};
