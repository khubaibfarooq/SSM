...
`,w=()=>(0,n.jsx)(t,{code:C,language:`html`,plugins:[`line-numbers`]}),T=`<div className="d-flex flex-wrap align-items-center gap-2">
<ButtonGroup>
...
`,A=()=>(0,n.jsx)(t,{code:k,language:`html`,plugins:[`line-numbers`]}),j=`
<!-- Buttons Toolbar -->
<ButtonToolbar>
...
`,M=()=>(0,n.jsx)(t,{code:j,language:`html`,plugins:[`line-numbers`]}),N=`
...
`,P=()=>(0,n.jsx)(t,{code:N,language:`html`,plugins:[`line-numbers`]}),F=`<Row>
...
`,I=()=>(0,n.jsx)(t,{code:F,language:`html`,plugins:[`line-numbers`]}),L=`
<!-- Ghost Buttons -->
...
`,R=()=>(0,n.jsx)(t,{code:L,language:`html`,plugins:[`line-numbers`]}),z=`
<!-- Load More Buttons -->
...
`,B=()=>(0,n.jsx)(t,{code:z,language:`html`,plugins:[`line-numbers`]}),V=`
<!-- Border Buttons -->
...
`,H=()=>(0,n.jsx)(t,{code:V,language:`html`,plugins:[`line-numbers`]}),U=`
...
`,X=()=>(0,n.jsx)(t,{code:Y,language:`html`,plugins:[`line-numbers`]}),Z=`
...
`,Q=()=>(0,n.jsx)(t,{code:Z,language:`html`,plugins:[`line-numbers`]});export{m as AnimationButtonsExample,K as BaseClassExample,H as BorderButtonsExample,E as CheckButtonsExample,J as CustomSizeExample,W as CustomToggleButtonsExample,i as DefaultButtonsExample,X as FocusRingExample,Q as FocusRingUtilityExample,R as GhostButtonsExample,f as GradientButtonsExample,w as GridButtonsExample,O as GroupButtonsExample,P as GroupsizingButtonsExample,A as IconButtonsExample,g as LabelButtonsExample,B as LoadingbuttonsExample,o as OutlineButtonsExample,c as RoundedButtonsExample,v as SizeButtonsExample,u as SoftButtonsExample,S as TagButtonsExample,M as ToolbarButtonsExample,I as VerticalButtonsExample,b as WidthButtonsExample};