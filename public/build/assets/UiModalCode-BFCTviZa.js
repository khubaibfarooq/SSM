...
`,u=()=>(0,n.jsx)(t,{code:l,language:`html`,plugins:[`line-numbers`]}),d=`<Modal
show={modal_togFirst}
onHide={tog_togFirst}
id="firstmodal"
centered
...
</Modal>`,f=()=>(0,n.jsx)(t,{code:d,language:`html`,plugins:[`line-numbers`]}),p=`
<!-- Default List -->
...
`,O=()=>(0,n.jsx)(t,{code:D,language:`html`,plugins:[`line-numbers`]});export{E as AnimationModalExample,o as CenteredModalExample,i as DefaultModalExample,w as FullscreenResponsiveExample,c as GridsModalExample,S as OptionalModalExample,O as PositionModalExample,v as ScrollableModalExample,u as StaticBackdropModalExample,f as TogglebetweenExample,g as TooltipModalExample,b as VaryingModalExample,m as onHidebetweenExample};