import{j as t}from"./app-BxV1Qh5z.js";import{P as n}from"./Prism-CITxvmdT.js";const a=`
<!-- Base Buttons -->
...
`,G=()=>t.jsx(n,{code:a,language:"html",plugins:["line-numbers"]}),e=`
<!-- Outline Buttons -->
...
`,I=()=>t.jsx(n,{code:e,language:"html",plugins:["line-numbers"]}),o=`
<!-- Rounded Buttons -->
...
`,j=()=>t.jsx(n,{code:o,language:"html",plugins:["line-numbers"]}),s=`
<!-- Soft Buttons -->
...
`,z=()=>t.jsx(n,{code:s,language:"html",plugins:["line-numbers"]}),i=`
<!-- Gradient Buttons -->
...
`,E=()=>t.jsx(n,{code:i,language:"html",plugins:["line-numbers"]}),r=`
<!-- Animation Buttons -->
...
`,R=()=>t.jsx(n,{code:r,language:"html",plugins:["line-numbers"]}),u=`
<!-- Buttons with Label -->
...
`,P=()=>t.jsx(n,{code:u,language:"html",plugins:["line-numbers"]}),l=`
<!-- Large Button -->
...
`,W=()=>t.jsx(n,{code:l,language:"html",plugins:["line-numbers"]}),c=`
<!-- Width Button -->
...
`,T=()=>t.jsx(n,{code:c,language:"html",plugins:["line-numbers"]}),m=`
<!-- Tag Button -->
...
`,U=()=>t.jsx(n,{code:m,language:"html",plugins:["line-numbers"]}),d=`
<!-- Buttons Grid -->
<div className="d-grid gap-2">
    <Button varient="primary"> Button </Button>
    <Button varient="primary"> Button </Button>
</div>
`,M=()=>t.jsx(n,{code:d,language:"html",plugins:["line-numbers"]}),B=`<div className="d-flex flex-wrap align-items-center gap-2">
<ButtonGroup>
...
`,F=()=>t.jsx(n,{code:B,language:"html",plugins:["line-numbers"]}),g=`
<!-- Buttons Group -->
<ButtonGroup>
...
`,O=()=>t.jsx(n,{code:g,language:"html",plugins:["line-numbers"]}),p=`
<!-- Buttons Group -->
...
`,A=()=>t.jsx(n,{code:p,language:"html",plugins:["line-numbers"]}),b=`
<!-- Buttons Toolbar -->
<ButtonToolbar>
...
`,V=()=>t.jsx(n,{code:b,language:"html",plugins:["line-numbers"]}),N=`
...
`,X=()=>t.jsx(n,{code:N,language:"html",plugins:["line-numbers"]}),v=`<Row>
...
`,Y=()=>t.jsx(n,{code:v,language:"html",plugins:["line-numbers"]}),f=`
<!-- Ghost Buttons -->
...
`,q=()=>t.jsx(n,{code:f,language:"html",plugins:["line-numbers"]}),h=`
<!-- Load More Buttons -->
...
`,H=()=>t.jsx(n,{code:h,language:"html",plugins:["line-numbers"]}),x=`
<!-- Border Buttons -->
...
`,J=()=>t.jsx(n,{code:x,language:"html",plugins:["line-numbers"]}),y=`
...
`,_=()=>t.jsx(n,{code:L,language:"html",plugins:["line-numbers"]}),S=`
...
`,$=()=>t.jsx(n,{code:S,language:"html",plugins:["line-numbers"]});export{R as AnimationButtonsExample,Q as BaseClassExample,J as BorderButtonsExample,F as CheckButtonsExample,Z as CustomSizeExample,K as CustomToggleButtonsExample,G as DefaultButtonsExample,_ as FocusRingExample,$ as FocusRingUtilityExample,q as GhostButtonsExample,E as GradientButtonsExample,M as GridButtonsExample,O as GroupButtonsExample,X as GroupsizingButtonsExample,A as IconButtonsExample,P as LabelButtonsExample,H as LoadingbuttonsExample,I as OutlineButtonsExample,j as RoundedButtonsExample,W as SizeButtonsExample,z as SoftButtonsExample,U as TagButtonsExample,V as ToolbarButtonsExample,Y as VerticalButtonsExample,T as WidthButtonsExample};
