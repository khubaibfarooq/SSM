import{j as e}from"./app-BxV1Qh5z.js";import{P as t}from"./Prism-CITxvmdT.js";const o=`
<!-- Display Headings -->
...
`,B=()=>e.jsx(t,{code:o,language:"html",plugins:["line-numbers"]}),l=`
<!-- Headings -->
...
`,T=()=>e.jsx(t,{code:l,language:"html",plugins:["line-numbers"]}),s=`
<!-- Blockquotes -->
...
`,C=()=>e.jsx(t,{code:s,language:"html",plugins:["line-numbers"]}),a=`
...
`,w=()=>e.jsx(t,{code:a,language:"html",plugins:["line-numbers"]}),m=`
...
`,E=()=>e.jsx(t,{code:m,language:"html",plugins:["line-numbers"]}),i=`
<!-- Inline Text -->
...
`,D=()=>e.jsx(t,{code:i,language:"html",plugins:["line-numbers"]}),c=`
<!-- Unstyle List -->
...
`,S=()=>e.jsx(t,{code:c,language:"html",plugins:["line-numbers"]}),n=`
<!-- Inline List -->
...
`,v=()=>e.jsx(t,{code:n,language:"html",plugins:["line-numbers"]}),u=`
<!-- Description List -->
...
`,j=()=>e.jsx(t,{code:u,language:"html",plugins:["line-numbers"]}),r=`
<!-- Text Wrap -->
<Badge bg="primary" className="text-wrap" style={{ width: "6rem" }}>
...
`,L=()=>e.jsx(t,{code:r,language:"html",plugins:["line-numbers"]}),d=`
<!-- Font size -->
...
`,A=()=>e.jsx(t,{code:d,language:"html",plugins:["line-numbers"]}),p=`
<!-- Word Break -->
...
`,I=()=>e.jsx(t,{code:p,language:"html",plugins:["line-numbers"]}),b=`
...
`,W=()=>e.jsx(t,{code:b,language:"html",plugins:["line-numbers"]}),g=`
<!-- Line height -->
...
`,P=()=>e.jsx(t,{code:g,language:"html",plugins:["line-numbers"]}),h=`
<!-- Text Transform -->
...
`,z=()=>e.jsx(t,{code:h,language:"html",plugins:["line-numbers"]}),x=`
<!-- Text Decoration -->
...
`,H=()=>e.jsx(t,{code:x,language:"html",plugins:["line-numbers"]}),k=`
<!-- Block level -->
<Row>
...
`,O=()=>e.jsx(t,{code:k,language:"html",plugins:["line-numbers"]}),q=`
<!-- Visibility -->
...
`,F=()=>e.jsx(t,{code:q,language:"html",plugins:["line-numbers"]}),f=`
<!-- Clearfix -->
...
`,V=()=>e.jsx(t,{code:f,language:"html",plugins:["line-numbers"]});export{E as BlockquoteBorderColorExample,w as BlockquoteColorExample,C as BlockquotesExample,V as ClearfixExample,j as DescriptionListExample,B as DisplayHeadingExample,A as FontSizeExample,W as FontWeightExample,T as HeadingsExample,v as InlineListExample,D as InlineTextExample,P as LineHeightExample,H as TextDecrationExample,z as TextTransformExample,O as TextTruncationExample,L as TextWrappingExample,S as UnstyleListExample,F as VisibilityExample,I as WordBreakExample};
