import{j as t,R as e}from"./app-BV4iq9AN.js";import{P as a}from"./Prism-C30nvFYC.js";const i=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
...
`,language:"html"})}),c=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
...
`,language:"html"})}),o=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<Row>
<Col xl={6}>
...
`,language:"html"})}),r=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<Row>
<Col xl={6}>
    <div className="table-responsive">
...
<Col xl={6}>
    ...
    `,language:"html"})}),n=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive table-card">
<Table className="align-middle table-nowrap mb-0">
...
`,language:"html"})}),m=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
<Table className="align-middle table-nowrap mb-0">
<thead>
    <tr>
...
`,language:"html"})}),h=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`
<div className="table-responsive">
...
`,language:"html"})}),b=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
<Table className="table-bordered border-secondary table-nowrap align-middle mb-0">
    ...
    `,language:"html"})}),p=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
...
`,language:"html"})}),u=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
...
`,language:"html"})}),N=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
<Table className="align-middle table-nowrap mb-0">
<thead className="table-light">
    <tr>
...
`,language:"html"})}),k=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
<Table className="table-nowrap mb-0">
    ...
    `,language:"html"})}),g=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
...
`,language:"html"})}),v=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
<Table className="caption-top table-nowrap mb-0">
    <caption>List of users</caption>
    <thead className="table-light">
        <tr>
...
`,language:"html"})}),f=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
<Table className="table-nowrap mb-0">
    <thead>
        <tr>
            <th scope="col">#</th>
...
`,language:"html"})}),w=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
...
`,language:"html"})}),L=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive">
<Table className="align-middle table-nowrap mb-0">
    <thead className="table-light">
        <tr>
            <th scope="col" style={{"width": "42px"}}>
...
`,language:"html"})}),x=()=>t.jsx(e.Fragment,{children:t.jsx(a,{code:`<div className="table-responsive table-card">
    ...
    `,language:"html"})});export{m as ActiveTables,h as BorderedTables,g as Captions,n as CardTables,i as DefaultTables,r as HoverableRows,L as ResponsiveTables,u as SmallTables,x as StripedColumnsTables,c as StrippedRow,k as TableFoot,N as TableHead,v as TableNesting,b as TablesBorderColors,o as TablesColors,p as TablesWithoutBorders,f as Variants,w as VerticalAlignment};
