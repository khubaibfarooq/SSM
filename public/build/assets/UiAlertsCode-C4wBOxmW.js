...
<Alert varient="dark" className="border-0 border-0 mb-0">
    <strong>Did you know?</strong> A simple <b>dark alert</b> —check it out!
</Alert>`,o=()=>(0,n.jsx)(t,{code:a,language:`html`,plugins:[`line-numbers`]}),s=`
<!-- Primary Alert -->
<Alert varient="primary">
...
</Alert>`,c=()=>(0,n.jsx)(t,{code:s,language:`html`,plugins:[`line-numbers`]}),l=`
<!-- Primary Alert -->
<Alert varient="primary">
...
</Alert>`,u=()=>(0,n.jsx)(t,{code:l,language:`html`,plugins:[`line-numbers`]}),d=`
const [show, setShow] = useState<boolean>(false);
<Alert varient="success" isOpen={show} toggle={() => setShow(false)}>
    Nice, you triggered this alert message!
</Alert>
<button type="button" className="btn btn-primary" id="liveAlertBtn" onClick={() => setShow(true)}>Show live alert</button>`,f=()=>(0,n.jsx)(t,{code:d,language:`jsx`,plugins:[`line-numbers`]}),p=`
<!-- Primary Alert -->
...
</Alert>`,m=()=>(0,n.jsx)(t,{code:p,language:`html`,plugins:[`line-numbers`]}),h=`
<!-- Primary Alert -->
...
</Alert>`,g=()=>(0,n.jsx)(t,{code:h,language:`html`,plugins:[`line-numbers`]}),_=`
<!-- Primary Alert -->
...
</Alert>`,v=()=>(0,n.jsx)(t,{code:_,language:`html`,plugins:[`line-numbers`]}),y=`
<!-- Primary Alert -->
...
</Alert>`,b=()=>(0,n.jsx)(t,{code:y,language:`html`,plugins:[`line-numbers`]}),x=`
<!-- Primary Alert -->
...
</Alert>`,S=()=>(0,n.jsx)(t,{code:x,language:`html`,plugins:[`line-numbers`]}),C=`
<!-- Primary Alert -->
...
</Alert>`,w=()=>(0,n.jsx)(t,{code:C,language:`html`,plugins:[`line-numbers`]}),T=`
<!-- Primary Alert -->
...
</Alert>`,O=()=>(0,n.jsx)(t,{code:D,language:`html`,plugins:[`line-numbers`]});export{E as AdditionalContentAlertsExample,o as BorderlessExample,i as DefaultAlertsExample,c as DismissingExample,v as LabelIconAlertsExample,S as LabelIconArrowAlertsExample,g as LeftBorderAlertsExample,u as LinkColorExample,f as LiveExample,m as OutlineAlertsExample,w as RoundedLabelIconAlertsExample,O as SolidAlertsExample,b as TopBarAlertsExample};